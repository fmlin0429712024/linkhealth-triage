...
### 1.1 Plugin folder + manifest — TODO
...
### 1.2 Client entry boots (smoke) — TODO
...
### 2.1 Capability-list schema validation — TODO (test first)
...
### 2.2 Defaults merge — TODO (test first)
...
### 2.3 Session-start parameter building — TODO (test first)
...
### 2.4 Brand token structure — TODO (test first)
...
### 3.2 Branded hero copy — TODO (smoke)
...
### 4.1 Full hot-reload cycle — TODO (manual checklist)
